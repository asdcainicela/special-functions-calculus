...
\begin{itemize}
	...
	\item \textbf{Aproximación de Stirling's}
	      ...
	      $$
		      \lim_{x \to \infty} \left(\frac{(x+k)^{x^{n+1}} \sqrt{x^{2x^n-x^{n-1}} }    }{x^{x^{n+1}} \Gamma^{x^{n-1}}(x) } \right) ^{x^{-n}}
	      $$

	      \resolucion

	      Reconocemos $(ab)^n=a^n \cdot b^n$
	      $$
		      \lim_{x \to \infty}\left(\dfrac{(x+k)^{x^{n+1}}     }{x^{x^{n+1}} } \right) ^{x^{-n}}\cdot
		      \left(\dfrac{ \sqrt{x^{2x^n-x^{n-1}} }    }{ \Gamma^{x^{n-1}}(x) } \right) ^{x^{-n}}
	      $$

	      Tambien vemos $a^n \cdot a^m=a^{n+m}$

	      $$
		      \lim_{x \to \infty}\dfrac{(x+k)^{x^{n+1-n}}     }{x^{x^{n+1-n}} } \cdot
		      \lim_{x \to \infty} \left(\dfrac{ \sqrt{x^{2x^{n-n+1}-x^{n-1-n+1}} }    }{ \Gamma^{x^{n-1-n+1}}(x) } \right)^{x^{-1}}
	      $$

	      $$
		      \lim_{x \to \infty}\dfrac{(x+k)^x     }{x^x } \cdot
	      ...
	      $$
		      \lim_{x \to \infty} \left( \dfrac{x+k    }{x }\right)^x  \cdot
	      ...
	      $$
		      e^k\lim_{x \to \infty} \left(\dfrac{x^{x+1/2} }{\sqrt{2\pi}\  x^{x+1/2} \ e^{-x}} \right)^{x^{-1}}
		      =
